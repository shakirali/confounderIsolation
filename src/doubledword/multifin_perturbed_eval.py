"""
MultiFin perturbed eval via Doubleword batch.

Writes under experiments/doubleword_batches/multifin/.
Eval model: Nemotron 120B. No /no_think prefix.
Full run: n=546 unique examples × 5 types = 2730 rows.

Usage (repo root):
    .venv/bin/python src/doubledword/multifin_perturbed_eval.py --n 10 --window 1h
    .venv/bin/python src/doubledword/multifin_perturbed_eval.py --window 24h
    .venv/bin/python src/doubledword/multifin_perturbed_eval.py --batch-id <uuid>
"""
...
def main():
    p = argparse.ArgumentParser(description="MultiFin perturbed Doubleword batch eval")
