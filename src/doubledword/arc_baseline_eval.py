"""
ARC-Challenge baseline eval via Doubleword batch (writes under experiments/doubleword_batches/arc/).
...
Usage (repo root):
    ...
    PYTHONPATH=src/doubledword uv run python src/doubledword/arc_baseline_eval.py --batch-id <uuid>
"""
...
def main():
    p = argparse.ArgumentParser(description="ARC-Challenge baseline Doubleword batch eval")
