...
def run_baseline_judge(
    ...
    Args:
        ...
        output_path: Output scored CSV path. Defaults to baseline_scored.csv inside the eval batch folder.
    ...
    if output_path is None:
        output_path = os.path.join(bdir, "baseline_scored.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default=None, help="Output scored CSV path (default: baseline_scored.csv inside eval batch folder)")
